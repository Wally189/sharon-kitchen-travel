...
const sessionCookieName = "sharon_kitchen_admin";
...
function normaliseSite(payload) {
  const businessName = cleanString(payload.businessName) || "Business name";

  return {
    theme: normaliseTheme(payload.theme),
    businessName,
    siteTitle: cleanString(payload.siteTitle) || `${businessName} | Static website`,
